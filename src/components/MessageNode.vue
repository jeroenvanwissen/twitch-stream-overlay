...
<template>
  <span
    class="message flex items-end flex-wrap gap-0.5"
    v-if="node.type == 'rootNode'"
    :id="node.id"
    :class="node.classes"
  >
  ...
  <img v-else-if="node.type == 'emote'" :id="node.id" class="size-7" :class="node.classes" v-bind="node.attribs" />
