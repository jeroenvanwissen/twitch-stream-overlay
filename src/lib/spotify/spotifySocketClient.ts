import { SpotifyEventType } from '@/types/spotify/shared';
import type { SpotifyEvent } from '@/types/spotify/shared';
...
import type { SpotifyLikePayload } from '@/types/spotify/like';
import { isSpotifyLikeEvent } from '@/types/spotify/like';
		...
		this.socket.onmessage = async (event: MessageEvent) => {
			...
			if (isSpotifyConnectEvent(data)) {
				...
				try {
					...
					console.error('Error processing Spotify like event:', error);
				}
			}
		};
